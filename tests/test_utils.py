...
from utils.servise import load_json,get_succesful_operations,sort_by_date,date_format,mask_card

def test_load_json():
    assert load_json('tests/test_data/correct.json') == []

    with pytest.raises(JSONDecodeError):
        assert load_json('tests/test_data/no_correct.json')
...
def test_sort_by_date():
    test_data1 = [
        {"date": "2019-04-19T12:02:30.129740"},
...
def test_get_last_five_successful_operations():
    ...
    assert get_succesful_operations(test_data2) == [
        {"state": "EXECUTED", "date": "2019-06-30T15:11:53.136004"},
        {"state": "EXECUTED", "date": "2019-04-19T12:02:30.129240"},
        {"state": "EXECUTED", "date": "2018-04-16T17:34:19.241289"},
        {"state": "EXECUTED", "date": "2018-02-13T04:43:11.374324"},
